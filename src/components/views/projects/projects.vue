  ...
  <section class="content">
    ...
    <div class="container search-wrapper" v-if="this.$route.meta.type != 'ProjectOverview'">
      <div class="row search">
        ...
        <button 
          v-if="$store.state.user_type != 'client' && $store.state.user_role == 'project_manager'"
              ...
              <div>
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <mdc-textfield
                      v-model="site.expected_end_date"
    ...
    <div class="row" v-if="this.$route.meta.type == 'ProjectOverview'">
      <div class="col-md-12 toolbar">
        <ul>
          ...
          <router-link
            tag="li"
            to="/dash/project/projects/costs"
            v-if="$store.state.user_type != 'client'"
          >
            <a href="#">Site Costs</a>
          </router-link>
          ...
          <router-link
            tag="li"
            to="/dash/project/projects/reports"
            v-if="$store.state.user_type != 'client'"
          >
            <a href="#">Reports</a>
          </router-link>
