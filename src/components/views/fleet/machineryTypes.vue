...
<div>
  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="comp-title col-md-2">
        <button type="button" data-toggle="modal" data-target="#addMachineryType" v-on:click="resetType()">
          Add type
        </button>
      </div>
    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="addMachineryType" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{ editMode ? 'Edit' : 'Add'}} Machinery type</h5>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" v-on:click="saveType" data-dismiss="modal">
              {{ editMode ? 'Edit' : 'Add'}} Machinery type
            </button>
          </div>
        </div>
      </div>
